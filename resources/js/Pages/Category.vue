...
<AuthenticatedLayout>
    ...
    <div class="w-full p-1 pt-2 mb-3">
        ...
        <div class="border border-gray-300 rounded-lg text-sm py-3.5 px-10 mb-4">
            1- {{$page.props.category_by_id.length}} of over {{$page.props.category_by_id.length}} result for {{$page.props.category_name.name}}
        </div>

        <div class="grid grid-cols-4 gap-1">
             
             <div v-for="product in $page.props.category_by_id" :key="product">
